...
Natural language is sequential by nature, characterized by complex syntactic structures that create meaning out of otherwise independent components. Consider the following sentence:$X^2 = Y$
