...
<Abstract>
  Linear-chain graphical models are compact, powerful and interpretable frameworks for the
  study of natural language. Their linear structure help them excel at sequence labeling
  problems like named entity recognition.
</Abstract>
