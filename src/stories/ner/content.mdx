...
An HMM with the structure outlined above was trained on the CoNLL-2003 English dataset [@Sang2003]. The training set contains 14,987 sentences, for a total of 203,621 word tokens. Here's the model in action:
