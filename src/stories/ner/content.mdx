...
An HMM with the structure outlined above was trained on the CoNLL-2003 English dataset [@Sang2003].

<LivePrediction models={['hmm']} label="Most likely state sequence by a trained HMM" />
