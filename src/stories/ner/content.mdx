...
“The UK” alone is a country, but “The UK Department of Transport” is an organization within said country. In a named entity recognition (NER) task [@Sundheim1995], where we want to label each word with a name tag (organization/person/location/not a name), how can a computer model know one from the other?
