...
import {
	hmmPrecisionByBinaryOOV,
	hmmPrecisionByEntityLength,
	hmmPrecisionByOOVRate,
	hmmRecallByBinaryOOV,
	hmmRecallByEntityLength,
	hmmRecallByOOVRate,
} from './partII/constants'
...
import {
	memmPrecisionByBinaryOOV,
	memmPrecisionByEntityLength,
	memmPrecisionByOOVRate,
	memmRecallByBinaryOOV,
	memmRecallByEntityLength,
	memmRecallByOOVRate,
} from './partIII/constants'
...
<BinaryOOVHeatmap precision={hmmPrecisionByBinaryOOV} recall={hmmRecallByBinaryOOV} />
...
<EntityLengthHeatmap
	precision={hmmPrecisionByEntityLength}
	recall={hmmRecallByEntityLength}
/>
...
<OOVRateHeatmap precision={hmmPrecisionByOOVRate} recall={hmmRecallByOOVRate} />
...
Overall, the model has better performance than its HMM equivalent. Per-word accuracy is slightly higher:

<MEMMPerWordScorecard />

Per-entity precision and recall are also notably higher:

<MEMMPerEntityScorecards />

A closer look at the results reveals that a significant part of the performance boost is attributable to better performance with OOV words:

<BinaryOOVHeatmap
	precision={memmPrecisionByBinaryOOV}
	recall={memmRecallByBinaryOOV}
	overlay={{
		name: 'HMM',
		precision: hmmPrecisionByBinaryOOV,
		recall: hmmRecallByBinaryOOV,
	}}
/>
...
<EntityLengthHeatmap
	precision={memmPrecisionByEntityLength}
	recall={memmRecallByEntityLength}
	overlay={{
		name: 'HMM',
		precision: hmmPrecisionByEntityLength,
		recall: hmmRecallByEntityLength,
...
<OOVRateHeatmap
	precision={memmPrecisionByOOVRate}
	recall={memmRecallByOOVRate}
	overlay={{
		name: 'HMM',
		precision: hmmPrecisionByOOVRate,
		recall: hmmRecallByOOVRate,
	}}
/>
